...
import {
  ...
  MsgPlayMove,
  MsgPlayMoveResponse,
  MsgRejectGame, MsgRejectGameResponse
...
export function isMsgCreateGameResponseEncodeObject(
  ...
  return (
      (encodeObject as MsgCreateGameResponseEncodeObject).typeUrl === typeUrlMsgCreateGameResponse
  )
}
...
export function isMsgPlayMoveResponseEncodeObject(
  ...
  return (
      (encodeObject as MsgPlayMoveResponseEncodeObject).typeUrl === typeUrlMsgPlayMoveResponse
  )
}
...
export function isMsgRejectGameEncodeObject(
  ...
  return (
      (encodeObject as MsgRejectGameEncodeObject).typeUrl === typeUrlMsgRejectGame
  )
}
...
export function isMsgRejectGameResponseEncodeObject(
  ...
  return (
      (encodeObject as MsgRejectGameResponseEncodeObject).typeUrl === typeUrlMsgRejectGameResponse
  )
}